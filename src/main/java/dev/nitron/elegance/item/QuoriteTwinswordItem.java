...
public class QuoriteTwinswordItem extends SwordItem implements ColorableItem {
    public QuoriteTwinswordItem(Settings settings) {
        super(ToolMaterials.DIAMOND, settings
                .component(ModComponentTypes.WEAPON_MODELS_COMPONENT, ModModelLoaders.QUORITE_TWINSWORD));
    }

    @Override
    public AttributeModifiersComponent getAttributeModifiers() {
        return AttributeModifiersComponent.builder().add(EntityAttributes.GENERIC_ATTACK_DAMAGE, new EntityAttributeModifier(BASE_ATTACK_DAMAGE_MODIFIER_ID, (double)((float)9), EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND).add(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(BASE_ATTACK_SPEED_MODIFIER_ID, (double)-2.8, EntityAttributeModifier.Operation.ADD_VALUE), AttributeModifierSlot.MAINHAND).build();
    }
